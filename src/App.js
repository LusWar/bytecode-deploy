...
import {contractLinkPrefix, contractLinkSuffix} from './msg';
                    ...
                    <Container fixed>
                        <Grid className={classes.contentTop}>
                            <Box fontWeight="fontWeightBold" fontSize={14} color="textPrimary">
                                [Step 1] Compile Contract By:
                            </Box>
                        </Grid>
                        <Grid container className={classes.content} justify="flex-start" spacing={4}>
                            <Grid item>
                                <Button variant="outlined" color="primary" href="https://etherscan.io/vyper" target="_blank" rel="noopener">
                                    Vyper Compiler
                                </Button>
                            </Grid>
                            <Grid item>
                                <Button variant="outlined" color="primary" href="http://remix.ethereum.org/" target="_blank" rel="noopener">
                                    Remix IDE
                                </Button>
                            </Grid>
                            <Grid item xs>
                        ...
                        <Grid className={classes.content}>
                            <Box fontWeight="fontWeightBold" fontSize={14} color="textPrimary">
                                [Step 2] Deploy Contract Using Bytecode:
                            </Box>
                        </Grid>
                        <TextField
                            className={classes.bytecodeText}
